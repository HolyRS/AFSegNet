from model.classification.models.vmamba import VSSM, LayerNorm2d, VSSBlock, Permute
import os
import time
import math
import copy
...
class CRF_RNN(nn.Module):
    ...
    def forward(self, unary_logits, image):
        ...
        for _ in range(self.num_iterations):
            spatial_out = F.avg_pool2d(Q, 7, 1, 3)
...
class MambaSegDecoder(nn.Module):
    def __init__(self, num_classes, encoder_channels=(64,128,256,512), depths=(2,2,2,2)):
        ...
        self.up0 = PatchExpand(C1//2,  C1//2 if C1>=2 else C1, scale=2)  # H/2 -> H
...
class AFSegNet(nn.Module):
    def __init__(self,
        ...
        self.decoder = MambaSegDecoder(num_classes=num_classes, encoder_channels=dims, depths=depths_vss)
