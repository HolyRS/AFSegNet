...
from model.models.AFSegNet import AFSegNet
...
# define the loss
loss = AFSegNetLoss(ignore_index=ignore_index)
use_aux_loss = True
...
train_dataset = VaihingenDataset(data_root='data/abandoned farmland/train_'+str(image_size), mode='train',
                                 mosaic_ratio=0.25, transform=train_aug)


val_dataset = VaihingenDataset(data_root='data/abandoned farmland/val_'+str(image_size),mode='val',
                               transform=val_aug)

test_dataset = VaihingenDataset(data_root='data/abandoned farmland/test_'+str(image_size),mode='test',
                                transform=val_aug)
